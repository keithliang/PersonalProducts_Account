...
<body>
            ...
            <div class="container">
                ...
                <div class="nav-collapse collapse">
                    <ul class="nav">
                        ...
                        <li class="active"><a href="print.aspx">列印資料</a></li>
                    </ul>
                </div>
                <!--/.nav-collapse -->
            </div>
    ...
    <div>
        ...
        <br />
        <asp:Button ID="Button1" runat="server" Text="MS-Excel Print (輸出Excel)" OnClick="Button1_Click" class="btn btn-success"/>
&nbsp;
       <asp:Button ID="Button2" runat="server" Text="PDF Print (輸出PDF)" OnClick="Button2_Click" class="btn btn-success"/>
    </div>
