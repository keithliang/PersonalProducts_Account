...
public partial class UpdateJournal : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                //ListItem select = new ListItem("請選擇", "-1");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string AccountUpdate, AccountDelate;
            while (dr.Read())
            {
                AccountUpdate = "<b><a href=UpdateJournalUpdate.aspx?id=" + dr["Id"] + ">選擇</a></b>";
                AccountDelate = "<b><a href=UpdateJournalDelate.aspx?id=" + dr["Id"] + ">選擇</a></b>";
                myTable.Rows.Add(BuildNewRow(Convert.ToDateTime(dr["Order_date"]).ToShortDateString(), dr["Assign_numbers"].ToString(), dr["Account_name"].ToString(), dr["Account_abstract"].ToString(), dr["Income"].ToString(), dr["Spend"].ToString(),AccountUpdate,AccountDelate));
            }
